    ...
    handleUpdate(event){
        ...
        if (!quotevalue) {
            ...
            this.orderDeliveryGroups.forEach(obj => {
                ...
                updateOrderDeliveryGroupByCSR({ orderDeliveryGroupId: obj.recordId, quoteNumber: obj.quoteNumber, originalMaterialNumber: obj.originalMaterialNumber, materialNumber: obj.materialNumber})
                .then(result => {
                    //(result);   
                    
                    getOrderDeliveryGroupData({ orderDeliveryGroupId: obj.recordId})
                    .then(result => {
                        //console.log(result); 
                        ...
                        //console.log('call event on parent ****' + obj.recordId );
